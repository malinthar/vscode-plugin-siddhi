...
//      return SnippetBlock.KEYWORD_DEFINE;
//    }
...
////        List<ParserRuleContext> namecontexts =
////                this.visitor.findRuleContexts((ParserRuleContext) lsContext.getContextTree().get(SiddhiQLParser.Siddhi_appContext.class.toString()), SiddhiQLParser.Attribute_nameContext.class);
...
//        snips.add(SnippetBlock.FUNCTION_DEFINITION);
//        return snips;
//    }
...
//        siddhiAppContextSnippets.add(SnippetBlock.FUNCTION_DEFINITION);
